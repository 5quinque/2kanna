 ...
 */
final class Version20191020102959 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE parent_id parent_id INT DEFAULT NULL, CHANGE title title VARCHAR(127) DEFAULT NULL, CHANGE latestpost latestpost DATETIME DEFAULT NULL, CHANGE image_name image_name VARCHAR(127) DEFAULT NULL');
    }
